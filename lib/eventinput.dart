            ...
            DropdownButton<String>(
                      ...
                      onChanged: (String? newValue) {
                        setState(() {
                          ...
                          // nameController.text = ''; // Clear the text field when the dropdown changes
                          nameController.text = selectedEventType;
                        });
                      },
                      items: <String>['','Birthday', 'Marriage Anniversary', 'Kids Birthday', 'New Year']
